        ...
        <div class="w-full max-w-md bg-slate-900/40 backdrop-blur-md border border-slate-800/80 rounded-2xl p-8 shadow-2xl reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out hover:border-slate-700 transition-all duration-300 hover:shadow-[0_0_20px_rgba(20,184,166,0.1)]">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" required class="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-teal-500 outline-none">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" required class="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-teal-500 outline-none">
                </div>
