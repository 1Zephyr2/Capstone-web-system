...
<body class="bg-slate-950 text-slate-200 antialiased min-h-screen">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-8 hover:border-slate-700 transition-all duration-300 hover:shadow-[0_0_20px_rgba(13,148,136,0.1)] reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('request.appointment') }}" class="text-xs px-3 py-1 bg-teal-600 hover:bg-teal-500 rounded-lg text-white font-medium transition-all duration-300">
            ...
            <div class="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-8 hover:border-slate-700 transition-all duration-300 hover:shadow-[0_0_20px_rgba(13,148,136,0.1)] reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out">
                ...
                <button onclick="toggleAddPetModal()" class="w-full mt-6 py-3 rounded-xl border border-dashed border-slate-700 text-slate-400 hover:text-white hover:border-teal-500 transition-all duration-300">
                    + Add Pet
                </button>
            </div>
        </div>
    ...
    <footer class="py-10 text-center border-t border-white/5 text-slate-500 text-sm hidden">
        ...
        <div id="add-pet-modal-content" class="bg-slate-900 border border-slate-800 rounded-2xl p-8 w-full max-w-md shadow-2xl transform scale-95 opacity-0 transition-all duration-300 ease-out">
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" class="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2 text-white mt-1 outline-none focus:border-teal-500 hover:border-slate-600 transition-all duration-300">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-semibold uppercase tracking-wider text-slate-500">Pet Type</label>
                        <select class="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2 text-white mt-1 outline-none focus:border-teal-500 hover:border-slate-600 transition-all duration-300 appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2020%2020%22%3E%3Cpath%20stroke%3D%22%236b7280%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%221.5%22%20d%3D%22M6%208l4%204%204-4%22%2F%3E%3C%2Fsvg%3E')] bg-[length:1.5em_1.5em] bg-[right_0.5rem_center] bg-no-repeat">
                            <option>Dog</option>
                            <option>Cat</option>
                            <option>Other</option>
                        </select>
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center justify-center w-full">
                        <label class="flex flex-col items-center justify-center w-full h-24 border-2 border-slate-800 border-dashed rounded-lg cursor-pointer bg-slate-950 hover:bg-slate-900 hover:border-teal-500 transition-all duration-300">
                ...
                <div>
                    ...
                    <input type="number" min="0" class="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2 text-white mt-1 outline-none focus:border-teal-500 hover:border-slate-600 transition-all duration-300 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none">
                </div>
                <div class="mt-8 flex gap-3">
                    ...
                    <button type="submit" class="flex-1 px-4 py-2 rounded-xl bg-teal-600 hover:bg-teal-500 text-white font-semibold transition-all duration-300">Add Pet</button>
                </div>
            </form>
        </div>
    </div>
